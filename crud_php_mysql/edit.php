...
<div class="container">
  ...
  <form action="update.php" method="post">
    ...
    <div class="mb-3">
      ...
      <input id="nombre" type="text" name="nombre" class="form-control" required maxlength="10" value="<?php echo htmlspecialchars($user['nombre']); ?>">
    ...
    <div class="mb-3">
      ...
      <input id="fecha_nacimiento" type="date" name="fecha_nacimiento" class="form-control" required value="<?php echo htmlspecialchars($user['fecha_nacimiento'] ?? ''); ?>">
      <div class="invalid-feedback" id="error-fecha"></div>
    </div>
    <div class="mb-3">
      <label class="form-label">Edad</label>
      <input id="edad" type="number" name="edad" class="form-control" required min="0" max="99" value="<?php echo htmlspecialchars($user['edad'] ?? ''); ?>">
...
<script>
  // Validación simple en cliente para edición
  (function(){
