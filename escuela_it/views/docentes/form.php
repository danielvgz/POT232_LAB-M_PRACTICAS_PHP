<div class="page-header"><h3><?php echo $row['id'] ? 'Editar' : 'Nuevo'; ?> docente</h3></div>
<form method="post" action="index.php?controller=docentes&action=save">
    ...
    <a class="btn btn-default" href="index.php?controller=docentes&action=index">Cancelar</a>
</form>
